...
describe("<CountryListItem />", () => {
  it("renders", () => {
    render(<CountryListItem country={data} data-testid="item" />);
  ...
  it("renders updated text", () => {
    render(<CountryListItem country={data} data-testid="item" />);
    expect(screen.getByText(/updated/gi)).toBeInTheDocument();
  });

  it("renders meta element", () => {
    // If meta element is rendered there will be a link to the covid page
